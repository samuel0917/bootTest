...
public class JdbcAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		log.info("use JdbcAuthenticationProvider authenticate start... authentication name... {}",authentication.getName());
		boolean isMatch=isMatch(authentication);
		log.info("use JdbcAuthenticationProvider authenticate complete... isMatch... {}",isMatch);
		if(isMatch){
...
//		        	BCryptPasswordEncoder bcryptPasswordEncoder = new BCryptPasswordEncoder();
	            boolean pmatches = passwordEncoder().matches((CharSequence) authentication.getCredentials(),user.getPassword());
	            log.info("use JdbcAuthenticationProvider isMatch start... pmatches... {}",pmatches);
	        	if(pmatches){
	        		return true;
	        	}else{
	            	log.info("use JdbcAuthenticationProvider isMatch start... password doesn't match... {}",authentication.getCredentials());
	            }
	        }else{
	        	log.info("use JdbcAuthenticationProvider isMatch start... username doesn't match... {}",authentication.getName());
	        }
		}else{
			log.info("use JdbcAuthenticationProvider isMatch start... username doesn't exist... {}",authentication.getName());
		}
        return false;
    }
