package com.wenchao.boottest.exception;
...
public class GlobalExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler({MissingServletRequestParameterException.class, ParameterException.class})
    public Result<String> requestMissingServletRequest(Exception ex) {
        LOGGER.error("request Exception:", ex);
        return ResponseMsgUtil.response(EnumResultCode.FAIL.getCode(), ex.getMessage(), null);
    }
